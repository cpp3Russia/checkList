...
export function ChecklistItem({
  ...
  const { activeTaskId, isRunning, pauseTimer, startTimer, getElapsedMs } = useTimerStore()
  ...
  const handleComplete = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    onComplete(item.id, item.images, completed, isCurrentActive ? getElapsedMs() : item.completedDurationMs)
  }
