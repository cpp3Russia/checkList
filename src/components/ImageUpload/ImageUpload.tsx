  ...
  return (
    <Box className="img-up">
      ...
      >
        {uploading ? (
          ...
          <Stack alignItems="center" spacing={1}>
            ...
            <span>{canUpload ? '点击上传图片' : '已达上传上限'}</span>
      ...
      <Dialog open={previewOpen} onClose={() => setPreviewOpen(false)} maxWidth="sm" fullWidth>
        <DialogContent>
          {previewImage && <img src={previewImage} alt="预览" style={{ width: '100%', borderRadius: 2 }} />}
        </DialogContent>
      </Dialog>
    </Box>
  )
