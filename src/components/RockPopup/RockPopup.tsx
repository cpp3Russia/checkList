  ...
  const playSound = (type: string) => {
    try {
      ...
      const soundConfigs: Record<string, { frequency: number; duration: number; type: OscillatorType }> = {
        ding: { frequency: 880, duration: 0.15, type: 'sine' },
        whoosh: { frequency: 220, duration: 0.3, type: 'sawtooth' },
        victory: { frequency: 660, duration: 0.5, type: 'sine' },
        typewriter: { frequency: 1200, duration: 0.05, type: 'square' }
      }
